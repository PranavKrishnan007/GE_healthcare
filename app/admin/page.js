...
const Admin = () => {
  ...
  return (
    <div className="w-screen p-6 h-screen">
      <TopBar admin={true}/>
      <div className="dark:bg-black dark:text-white flex flex-col py-2 px-4">
        ...
        { authorised ? (
          <div className="p-5 bg-white dark:bg-black transition-all ease-in-out rounded shadow-sm w-full">
            <div>
              <div className="flex min-h-[300px] items-center justify-center w-full">
                <div className="rounded-xl overflow-hidden relative text-center p-4 group items-center flex flex-col max-w-sm hover:shadow-2xl transition-all duration-500 shadow-xl">
                  ...
                  <div className="group-hover:pb-10 transition-all duration-500 delay-200">
                    <h1 className="font-semibold text-gray-700">Admin</h1>
          ...
          <div className="flex w-fullnp justify-center items-center text-center">
